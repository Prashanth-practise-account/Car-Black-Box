...
void main(void)
{
    ...
    while (1)
    {
        ...
        else if(menu_flag==1)
        {
            ...
            clcd_print(menu[k], (0x80 + (2)));
            clcd_print(menu[k+1], (0xC0 + (2)));
        }
        ...
        else if(clear_flag==1)
        {
            ...
            clcd_print("Just a minute", (0xC0 + (0)));
            while(delay++<300000);
            delay=0;
            menu_flag=1;
            k=0;
        ...
        else if(settime_flag==1)
        {
            ...
            clcd_putch((hour/10) + '0', (0xC0 + (0)));
            clcd_putch((hour%10) + '0',(0xC0 + (1)));
            if(field==0)
            {
                while(delay++ < 50000);
                delay=0;
